...
export const REWARD_ITEMS = {
  styeTreasure: { id: 'styeTreasure', roomType: 'treasure', name: '麦粒肿', enName: 'Stye', titleText: '麦粒肿', flavorText: '“看得更仔细一点”', quality: 2, emoji: '👁️', slot: 'head', tone: 'treasure', description: '每天第一次 4 连及以上，额外获得本次结算资源 +2。', effect: { type: 'firstBigMatchBonus', amount: 2 }, reaction: '小猪眨了眨眼。它看起来更专注了。' },
  styeDevil: { id: 'styeDevil', roomType: 'devil', name: '麦粒肿', enName: 'Stye', titleText: '麦粒肿', flavorText: '“看得更深，也更疼”', quality: 3, emoji: '👁️‍🗨️', slot: 'head', tone: 'devil', description: '每天第一次 4 连及以上，额外获得本次结算资源 +4。', effect: { type: 'firstBigMatchBonus', amount: 4 }, penalty: { type: 'nextDaySteps', value: 2 }, penaltyText: '明天初始步数 -2。', reaction: '小猪努力睁大眼睛，但明显不太高兴。' },
  luckyFoot: { id: 'luckyFoot', roomType: 'treasure', name: '幸运脚', enName: 'Lucky Foot', titleText: '幸运脚', flavorText: '“总有一步踩在好运上”', quality: 2, emoji: '🍀', slot: 'feet', tone: 'treasure', description: '每天第一次连锁达到 2 轮时，本次结算资源 +2。', effect: { type: 'chainBonus', minChain: 2, amount: 2 }, reaction: '小猪踩到一片幸运草，装作这是它安排好的。' },
  lunch: { id: 'lunch', roomType: 'treasure', name: '午餐', enName: 'Lunch', titleText: '午餐', flavorText: '“先吃饱，再继续修”', quality: 1, emoji: '🥪', slot: 'side', tone: 'treasure', description: '下一天开始时额外 +2 步，不超过当前上限。', effect: { type: 'dayStartStepBonus', amount: 2 }, reaction: '小猪认真闻了闻，决定先替你保管。' },
  sackOfPennies: { id: 'sackOfPennies', roomType: 'treasure', name: '硬币袋', enName: 'Sack of Pennies', titleText: '硬币袋', flavorText: '“叮当作响的安慰奖”', quality: 2, emoji: '💰', slot: 'side', tone: 'treasure', description: '每天第一次资源结算时，随机一个当前目标资源 +4。', effect: { type: 'firstTargetResourceBonus', amount: 4 }, reaction: '袋子叮当响。小猪听起来很满意。' },
  battery: { id: 'battery', roomType: 'treasure', name: '小电池', enName: 'The Battery', titleText: '小电池', flavorText: '“再撑一小会儿”', quality: 2, emoji: '🔋', slot: 'back', tone: 'treasure', description: '每天第一次 5 连及以上，恢复 1 步。', effect: { type: 'firstFiveMatchStep', amount: 1 }, reaction: '小猪背着电池，看起来像一台很小的工程车。' },
  holyWater: { id: 'holyWater', roomType: 'treasure', name: '圣水', enName: 'Holy Water', titleText: '圣水', flavorText: '“出错时也留一点余地”', quality: 2, emoji: '💧', slot: 'float', tone: 'treasure', description: '每天第一次无效交换会返还 1 步。', effect: { type: 'firstInvalidSwapForgive', amount: 1 }, reaction: '水滴落在地上，小猪谨慎地往旁边挪了一点。' },
  compass: { id: 'compass', roomType: 'treasure', name: '指南针', enName: 'The Compass', titleText: '指南针', flavorText: '“总能指到更顺的方向”', quality: 2, emoji: '🧭', slot: 'side', tone: 'treasure', description: '每天第一次 4 连及以上，额外恢复 1 点小猪能量。', effect: { type: 'firstBigMatchPigEnergy', amount: 1 }, reaction: '指南针转了半圈，最后指向了小猪。' },
  momsKey: { id: 'momsKey', roomType: 'treasure', name: '妈妈的钥匙', enName: "Mom's Key", titleText: '妈妈的钥匙', flavorText: '“最后那扇门会开”', quality: 3, emoji: '🗝️', slot: 'float', tone: 'treasure', description: '第 9 天迪精仪式中，第一次阶段目标进度额外 +1。', effect: { type: 'djinnProgressBonus', amount: 1 }, reaction: '钥匙轻轻晃着，像是在等最后一扇门。' },
  brimstone: { id: 'brimstone', roomType: 'devil', name: '硫磺火', enName: 'Brimstone', titleText: '硫磺火', flavorText: '“烧得更快，也更狠”', quality: 4, emoji: '🔥', slot: 'back', tone: 'devil', description: '每天第一次 5 连及以上，本次结算资源 +6。', effect: { type: 'firstFiveMatchBonus', amount: 6 }, penalty: { type: 'nextDaySteps', value: 4 }, penaltyText: '明天初始步数 -4。', reaction: '小猪背后冒出一点火光。它假装这很正常。' },
  momsKnife: { id: 'momsKnife', roomType: 'devil', name: '妈妈的刀', enName: "Mom's Knife", titleText: '妈妈的刀', flavorText: '“失败一次，也要见血”', quality: 4, emoji: '🔪', slot: 'side', tone: 'devil', description: '每天第一次无效交换后，被交换资源各额外 +3。', effect: { type: 'invalidSwapBonus', amount: 3 }, penalty: { type: 'nextDaySteps', value: 3 }, penaltyText: '明天初始步数 -3。', reaction: '小猪盯着那把刀看了很久。最好别问它从哪来的。' },
  thePact: { id: 'thePact', roomType: 'devil', name: '契约', enName: 'The Pact', titleText: '契约', flavorText: '“写下名字，就会少一点什么”', quality: 3, emoji: '📜', slot: 'side', tone: 'devil', description: '每天开始时，两个当前目标需求各减少 3。', effect: { type: 'dayStartNeedReduction', amount: 3, targets: 2 }, penalty: { type: 'maxSteps', value: 1 }, penaltyText: '永久步数上限 -1。', reaction: '羊皮纸卷了起来，小猪非常谨慎地没签名。' },
  deadCat: { id: 'deadCat', roomType: 'devil', name: '死猫', enName: 'Dead Cat', titleText: '死猫', flavorText: '“还能回来，但不会毫无代价”', quality: 3, emoji: '🐈‍⬛', slot: 'back', tone: 'devil', description: '每天第一次步数归零时，自动恢复 4 步。', effect: { type: 'firstZeroStepRecover', amount: 4 }, penalty: { type: 'maxSteps', value: 2 }, penaltyText: '永久步数上限 -2。', reaction: '黑猫趴在旁边，小猪决定暂时不发表意见。' },
  pentagram: { id: 'pentagram', roomType: 'devil', name: '五芒星', enName: 'Pentagram', titleText: '五芒星', flavorText: '“贪心一点，回报也会更响”', quality: 3, emoji: '🔻', slot: 'float', tone: 'devil', description: '所有 4 连及以上，本次结算资源 +2。', effect: { type: 'allBigMatchBonus', amount: 2 }, penalty: { type: 'nextDaySteps', value: 4 }, penaltyText: '明天初始步数 -4。', reaction: '红色符号亮了一下，小猪假装没看见。' },
  guppysPaw: { id: 'guppysPaw', roomType: 'devil', name: '嗝屁猫的爪子', enName: "Guppy's Paw", titleText: '嗝屁猫的爪子', flavorText: '“快撑不住时还能再挠一下”', quality: 2, emoji: '🐾', slot: 'feet', tone: 'devil', description: '步数 ≤3 时，每天第一次消耗 1 点小猪能量恢复 4 步。', effect: { type: 'lowStepPigEnergyRecover', amount: 4, energyCost: 1, threshold: 3 }, penalty: { type: 'nextDaySteps', value: 2, pigMood: 1 }, penaltyText: '明天初始步数 -2，小猪心情 -1。', reaction: '小猪把爪印看了又看，觉得这不是正规奶茶券。' },
  blackCandle: { id: 'blackCandle', roomType: 'devil', name: '黑蜡烛', enName: 'Black Candle', titleText: '黑蜡烛', flavorText: '“火焰稳着，但不太吉利”', quality: 3, emoji: '🕯️', slot: 'back', tone: 'devil', description: '每天第一次资源结算时，当前目标资源额外 +5。', effect: { type: 'firstTargetResourceBonus', amount: 5 }, penalty: { type: 'maxSteps', value: 1 }, penaltyText: '永久步数上限 -1。', reaction: '黑蜡烛没有风也在晃。小猪离它远了一点。' },
  whoreOfBabylon: { id: 'whoreOfBabylon', roomType: 'devil', name: '巴比伦大淫妇', enName: 'Whore of Babylon', titleText: '巴比伦大淫妇', flavorText: '“越危险，越能逞强”', quality: 3, emoji: '💄', slot: 'head', tone: 'devil', description: '步数 ≤5 时，所有资源收益 +40%。', effect: { type: 'lowStepResourceBoost', threshold: 5, multiplier: 1.4 }, penalty: { type: 'nextDaySteps', value: 5 }, penaltyText: '明天初始步数 -5。', reaction: '小猪看起来很有气势，也很想下班。' },
  abaddon: { id: 'abaddon', roomType: 'devil', name: '亚巴顿', enName: 'Abaddon', titleText: '亚巴顿', flavorText: '“一次削掉最大的负担”', quality: 4, emoji: '😈', slot: 'head', tone: 'devil', description: '每天开始时，当前最高目标需求减少 6。', effect: { type: 'dayStartNeedReduction', amount: 6, targets: 1 }, penalty: { type: 'maxSteps', value: 2 }, penaltyText: '永久步数上限 -2。', reaction: '小猪头上多了个角。它没有承认。' },
  mawOfTheVoid: { id: 'mawOfTheVoid', roomType: 'devil', name: '虚空之喉', enName: 'Maw of the Void', titleText: '虚空之喉', flavorText: '“连锁够深，才会回应”', quality: 3, emoji: '⚫', slot: 'float', tone: 'devil', description: '每天第一次连锁达到 3 轮时，本次结算资源 +8。', effect: { type: 'chainBonus', minChain: 3, amount: 8 }, penalty: { type: 'nextDaySteps', value: 5 }, penaltyText: '明天初始步数 -5。', reaction: '黑色圆点浮在旁边，小猪决定不把鼻子伸进去。' },
  eyeOfBelial: { id: 'eyeOfBelial', roomType: 'devil', name: '恶魔之眼', enName: 'Eye of Belial', titleText: '恶魔之眼', flavorText: '“专门盯着你最缺的那一项”', quality: 3, emoji: '👁️‍🗨️', slot: 'float', tone: 'devil', description: '每天第一次 4 连及以上，当前最高目标资源 +6。', effect: { type: 'firstHighestNeedBonus', amount: 6 }, penalty: { type: 'nextDaySteps', value: 4 }, penaltyText: '明天初始步数 -4。', reaction: '那只眼睛盯着棋盘，小猪盯着那只眼睛。' },
  theMark: { id: 'theMark', roomType: 'devil', name: '印记', enName: 'The Mark', titleText: '印记', flavorText: '“留下标记，也留下代价”', quality: 3, emoji: '🩸', slot: 'head', tone: 'devil', description: '每天第一次 5 连及以上，全部当前目标资源各 +3。', effect: { type: 'firstFiveAllTargetsBonus', amount: 3 }, penalty: { type: 'maxSteps', value: 1, pigMood: 1 }, penaltyText: '永久步数上限 -1，小猪心情 -1。', reaction: '小猪额头上多了个印记。它觉得这事很可疑。' },
  sacrificialDagger: { id: 'sacrificialDagger', roomType: 'devil', name: '献祭匕首', enName: 'Sacrificial Dagger', titleText: '献祭匕首', flavorText: '“最后一夜，也要更锋利”', quality: 4, emoji: '🗡️', slot: 'side', tone: 'devil', description: '第 9 天迪精仪式中，每个阶段第一次目标进度额外 +1。', effect: { type: 'djinnProgressBonus', amount: 1, perStage: true }, penalty: { type: 'nextDaySteps', value: 4 }, penaltyText: '第 9 天初始步数 -4。', reaction: '匕首绕着小猪转了一圈。小猪选择不动。' },
  littleBrimstone: { id: 'littleBrimstone', roomType: 'devil', name: '小硫磺火', enName: 'Little Brimstone', titleText: '小硫磺火', flavorText: '“最后一天也能多喷一口”', quality: 3, emoji: '🐷🔥', slot: 'back', tone: 'devil', description: '第 9 天每个阶段第一次 4 连及以上，目标进度额外 +1。', effect: { type: 'djinnBigMatchProgressBonus', amount: 1 }, penalty: { type: 'nextDaySteps', value: 3 }, penaltyText: '第 9 天初始步数 -3。', reaction: '小猪喷出一点点火星，假装只是打了个嗝。' }
}
