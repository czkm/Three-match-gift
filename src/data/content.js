...
export const ACHIEVEMENTS = [
  ...
  },
  {
    ...
    title: '燈還亮著唷',
    description:
      '第 6 天完成温室修复，而且当天打出过一次连击或四连以上狸～厲害！',
    icon: '🌱',
    iconFile: 'day6_keep_the_lamp_warm',
    rarity: 'rare',
    hidden: false,
    flavor: '燈亮著～植物就願意活下去狸！',
  ...
  },
  {
    ...
    rarity: 'rare',
    hidden: false,
    flavor: '湯還沒好～但家的味道出来了狸！',
    trigger: { type: 'dayComplete', day: 8 }
  },
  {
    id: 'day9_room_for_her',
    title: '她的房間',
    description: '第 9 天走到结局了狸～完整的故事在這裡结束了狸！',
    icon: '🛏️',
    iconFile: 'day9_room_for_her',
    rarity: 'epic',
    hidden: true,
    flavor: '窗邊有花～床邊有光～她的位置準備好了狸！',
    trigger: { type: 'ending' }
  },
  {
    id: 'sunlit_margin',
    ...
    rarity: 'common',
    hidden: false,
    flavor: '太陽還高高的～今天就修好了狸！',
    trigger: { type: 'dayComplete' }
  },
  {
    id: 'clutch_finish',
    title: '剛剛好就行',
    description: '任意一天完成修复时，剩余步数不超过 5 狸～驚險過關！',
    icon: '⏳',
    iconFile: 'clutch_finish',
    rarity: 'rare',
    hidden: false,
    flavor: '差一點也夠～夠把今天做完狸！',
    trigger: { type: 'dayComplete' }
  },
  {
    id: 'cascade_poetry',
    title: '連續消除！',
    description: '一次出手打出三连击以上狸～太帥了！',
    icon: '✨',
    iconFile: 'cascade_poetry',
    rarity: 'epic',
    hidden: false,
    flavor: '咚咚咚一連串清響狸～整個莊園都醒了狸！',
    trigger: { type: 'combo' }
  },
  {
    id: 'grand_harvest',
    title: '大豐收啦！',
    description: '湊出一次五连以上狸～超厲害！',
    icon: '🍷',
    iconFile: 'grand_harvest',
    rarity: 'epic',
    hidden: false,
    flavor: '酒還在釀～豐收的樣子已經来了狸！',
    trigger: { type: 'matchGroup' }
  },
  {
    id: 'love_from_xiaokun',
    title: '愛你的小坤',
    description: '完整通关并走到最终结局之后解锁狸～謝謝你玩到這裡！',
    icon: '💛',
    iconFile: 'love_from_xiaokun',
    rarity: 'gold',
    hidden: true,
    flavor: '果園的盡頭～是一封終於寄到的信狸！',
    trigger: { type: 'ending' }
  }
]
